...
- Made interactive (panning/zooming)
- Set color to x value (range of 0 - 100 or white to blue)
...
my_chart = (bar + line).properties(width=600)

st.altair_chart(my_chart, use_container_width=True)

st.markdown("""
The 2 changes I made were:
- Changed line color to yellow (from red)
- Added title to chart
"""
)
